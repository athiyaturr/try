...
import com.example.finalproject.AddAdapter
...
class FragmentAdd : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rvadd: RecyclerView = view.findViewById(R.id.recyclerAdd)
        ...
        rvadd.layoutManager = GridLayoutManager(activity,2)
        //set adapter recycler view
        rvadd.adapter = AlbumAdapter(listData)

        //instance button add album
        val btnAddAlbum:Button = view.findViewById(R.id.buttonAddAlbum)
        //event
